...
parser = argparse.ArgumentParser(description='Программа рассчитывает радиус скопления, плотность фона и их ошибки методом интегрирования по радиальным профилям плотности')
parser.add_argument("name", help='Название скопления (как в файлах density_ИМЯ_МАГНИТУДА_ПОЛУШИРИНА.txt)')
parser.add_argument("h", help='Полуширина ядра (как в файлах density_ИМЯ_МАГНИТУДА_ПОЛУШИРИНА.txt)')
