...
parser = argparse.ArgumentParser(description='Программа интегрирует все радиальные профили плотности, нужны файлы "parameters_ИМЯ_h=ПОЛУШИРИНА.txt" и "density_ИМЯ_МАГНИТУДА_ПОЛУШИРИНА.txt" в текущем каталоге, запускать например: "python starcounter.py NGC7142 2"')
parser.add_argument('name', type=str, help="Имя скопления (как в названиях файлов)")
parser.add_argument('h', type=str, help="Полуширина ядра (как в названиях файлов (если с нулем - то пишите с нулём))")
