...
parser = argparse.ArgumentParser(description='Calculate centers of clusters and radial density profiles for every limiting magnitude.')
parser.add_argument("infile", help='input file name')
parser.add_argument("name", help="set clustername for map titles")
parser.add_argument("delta", type=float, help="bandwidth of the kernel, arcmin")
parser.add_argument("-l", "--maglim", default=21, help="set limiting G magnitude, default 21")
parser.add_argument("-s", "--step", default=0.05, help="set step, default 0.05'")
parser.add_argument("-r", "--rmax", default=30, help="set maximum distance from center, default 30'")
...
#           s2[i] += dens_mag[i]**2 
    ...
    plt.title("Радиальный профиль плотности {0},\nh={1}', Glim={2}m".format(name, delta, maglim), fontsize=26)
