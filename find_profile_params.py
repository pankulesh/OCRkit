...
def count_R_Fb(mag):
    ...
    plt.title("{0}, h={1}', Maglim={2}m".format(name, h, mag), fontsize=20)
    ...
    ax.legend()
    ax.set_xlabel(r'distance from center, $arcmin$', fontsize=16)
    ax.set_ylabel(r'radial density, $1/arcmin^2$', fontsize=16)
